        ...
        >
            ...
            <section className="max-w-[1440px] mx-auto px-6 py-24">
                <div className="flex justify-between items-end mb-12">
                    <div>
                        <h2 className="text-4xl font-black uppercase tracking-tighter">Selected Picks</h2>
                        <p className="text-gray-400 font-medium">Curated products for your lifestyle.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { src: Pharmacy, alt: 'Dry Fruits', path: '/category/dryfruits', label: 'PREMIUM DRY FRUITS' },
                        {
                            src: Petcare,
                        ...
                        { src: Babycare, alt: 'Fruits', path: '/category/fruits', label: 'FRESH HARVEST' },
                    ].map((item, idx) => (
                        <motion.div
                            key={item.alt}
                            whileHover={{ y: -10 }}
                        ...
                        >
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-8 text-white">
                                <span className="text-[10px] font-black uppercase tracking-[0.3em] mb-2 block opacity-60">Category 0{idx + 1}</span>
                                <h3 className="text-2xl font-black uppercase tracking-tighter mb-4">{item.label}</h3>
